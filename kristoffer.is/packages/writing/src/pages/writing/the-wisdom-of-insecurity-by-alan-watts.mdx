...
export const metadata = {
  ...
  excerpt:
    "The book, published in the early ’50s, is written for the new age, a time after World War 2, a time with atomic bombs. How does man find purpose in the day of science, a godless age?",
  tags: ["literature"],
